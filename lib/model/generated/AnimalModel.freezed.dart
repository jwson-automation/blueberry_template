...
/// @nodoc
mixin _$AnimalModel {
  int get animalId => throw _privateConstructorUsedError;
...
class _$AnimalModelImpl implements _AnimalModel {
  ...
  @override
  String toString() {
    return 'AnimalModel(animalId: $animalId, userId: $userId, name: $name, species: $species, breed: $breed, age: $age, gender: $gender, profilePicture: $profilePicture, bio: $bio)';
  }
...
abstract class _AnimalModel implements AnimalModel {
  const factory _AnimalModel(
      ...
      final String? gender,
      final String? profilePicture,
      final String? bio}) = _$AnimalModelImpl;
