...
class FixSettingCameraMediaPage extends ConsumerWidget {
  ...
  Future<dynamic> cameraQualitySetBottomSheet(BuildContext context, WidgetRef ref) {
  ...
  Future<dynamic> imageQualitySetBottomSheet(BuildContext context, WidgetRef ref) {
    return showModalBottomSheet(
        context: context,
        builder: (context) {
          return Padding(
            ...
            child: Container(
              ...
              child: Column(
                children: [
                  TextButton(
                    onPressed: () {
                      ref.read(imageQualityProvider.notifier).setImageQuality(false);
                      Navigator.pop(context);
                    },
                    child: const Text("일반화질"),
                  ),
